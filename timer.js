...
let volumeBarForest=document.querySelector('.volumeForest')
let volumeBarRain=document.querySelector('.volumeRain')
let volumeBarCoffe=document.querySelector('.volumeCoffe')
let volumeBarFire=document.querySelector('.volumeFire')
...
volumeBarForest.addEventListener('input',function(){
  forestAudio.volume=volumeBarForest.value /100;
})

volumeBarRain.addEventListener('input',function(){
  rainAudio.volume=volumeBarRain.value /100;
})

volumeBarCoffe.addEventListener('input',function(){
  coffeAudio.volume=volumeBarCoffe.value /100;
})

volumeBarFire.addEventListener('input',function(){
  fireAudio.volume=volumeBarFire.value /100;
})
